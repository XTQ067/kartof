...
Help = CmdHelp('filter').add_command('filters', None,'Bir söhbətdəki bütün filterləri göstərər.')
Help.add_command('filter','<filter olunacaq söz/cavablanacaq mətn>','Filter əlavə edər. Nə zaman əlavə etdiyinz söz/cümla yazılarsa bot cavab verər.','.filter "salam" "aleykum"')
Help.add_command('stop','<filter>','Seçilen filteri durdurar.', 'stop salam')
Help.add_command('genelfilter','<filterlənəcək söz/cavablanacaq mətn>','Ümumi filtrə əlavə edəd. Bütün qruplarda işləyər.')
Help.add_command('genelstop','<filter>', 'Seçilən ümumi filtreni durdurar.', 'genelstop salam')
Help.add()
