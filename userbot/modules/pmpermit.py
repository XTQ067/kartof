...
async def approvepm(apprvpm):
    ...
    if BOTLOG:
        await apprvpm.client.send_message(BOTLOG_CHATID, "#TƏSDIQLƏNDI\n" + "İsdifadəçi: " + mention)
...
async def blockpm(block):
    if block.reply_to_msg_id:
        ...
        if block.chat_id in BRAIN_CHECKER:
            await block.edit("`Sahibimi blok edə bilmərəm.`")
            return
...
Help = CmdHelp('pmpermit').add_command('approve', None, 'Cavab verilən isdifadəçiyə PM atma icazəsi verər.',)
Help.add_command('disapprove', None, 'Cavab verilən isdifadəçinin PM atma icazəsini qaldırar.')
Help.add_command('block', '<isdifadəçi adı/cavab>', 'İsdifadəçini bloklayar.')
Help.add_command('unblock', '<isdifadəçi adı/cavab>', 'İsdifadəçini blokdan çıxarar.')
Help.add_command('notifoff', None, 'Təsdiqlənməmiş şəxsi mesajların bildirişlərini təmizləyir və ya aradan qaldırır..')
Help.add_command('notifon', None, 'Təsdiqlənməmiş xüsusi mesajların bildiriş göndərməsinə imkan verir..')
Help.add()
