...
async def shazam(event):
    if not event.is_reply:
        ...
        await event.edit('**Səs faylı fingerprint formaətına çevrilir...**')
        ...
        if 'track' not in sarki:
            return await event.edit('**Təssüf ki, Shazam bu səsi tapa bilmədi. 😕\nDaha aydın səs atın.**')
        await event.edit('✨ **Mahnını tapdım, .əlumatları göndərirəm...** ✨')
