...
Help = CmdHelp('evaluators')
Help.add_command('eval <əməliyyat>','Kiçik ifadələri dəyərləndirin.','eval 2+3')
Help.add_command('exec','<python kodu>','Kiçik Python komanlarını işə salın.','exec print("N Σ O N")')
Help.add_command('term','<əməliyyat>','Serverinizdəki bash komandaları vs komanda fayllarını işə salar.','term ls')
Help.add()
